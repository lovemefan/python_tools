...
url_template = "https://m.weibo.cn/api/container/getIndex?type=wb&queryVal={}&containerid=1076031981833634&type=2%26q%3D{}&page={}"
...
def fetch_data(query_val, page_id):
    ...
    card_group = json.loads(resp.text)['data']['cards']
